...
export default function ContactSection() {
  return (
    <section id="book-test-drive" className="relative overflow-clip bg-white" aria-label="Contact">
      ...
      <div className="relative mx-auto flex w-full max-w-[1440px] flex-col gap-6 px-5 pb-6 pt-6 lg:flex-row lg:items-center lg:justify-between lg:px-[80px] lg:pb-[42px] lg:pt-[64px]">
        ...
        {/* form card — desktop variant, Figma 1:2006/1:2007 exact:
            517 × 683.477 · p-32 · gap-32 · radius 16 */}
        <div className="hidden w-[517px] shrink-0 flex-col gap-8 rounded-2xl bg-surface p-8 lg:flex lg:h-[683.477px]">
